...
videoRouter.route('/upload/:filename')
            ...
            gfs.find({ filename: req.params.filename }).toArray((err,files)=>{
                if (files[0] || files.length !== 0) {
                    ...
                    return res.status(200).json({
                        success: false,
                        message: 'video file already present in DB',
                    });
                }

                res.send("video upload sucessfull");

            });
            // check for existing videos
            // Video.findOne({ filename: req.body.filename })
            //     .then((video) => {
            //         console.log(video);
            //         if (video) {
            //             return res.status(200).json({
...
//     /*
//         POST: Upload a single Video/file to Video collection
//     */
//         videoRouter.route('/upload/:filename')
